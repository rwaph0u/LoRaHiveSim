const STRINGS = {
  en: {
    ...
    clickModes: "Click Modes:",
    clickNormal: "Click → Hives first, then obstacles",
    clickShift: "Shift+Click → Force obstacle selection", 
    clickAlt: "Alt+Click → Force hive selection only",
  ...
  fr: {
    ...
    clickModes: "Modes de Clic:",
    clickNormal: "Clic → Ruchers d'abord, puis obstacles",
    clickShift: "Maj+Clic → Forcer sélection d'obstacle",
    clickAlt: "Alt+Clic → Forcer sélection de rucher uniquement",
